...
type CreateRequest struct {
	...
	Balance        float64  `json:"balance"`                          // opening balance, 0 default
...
//
// `description` and `note` are presence-tracked: field absent → leave
// alone; explicit `null` → clear the column. Same convention as
// categories.UpdateCategoryRequest.parent_id.
...
// DescriptionChange / NoteChange follow the categories convention: the
// bool tells the service "the client touched this field"; the *string
// is the new value (nil = clear).
